...
const cloneDeMenu = menu.cloneNode(true);
copy.appendChild(cloneDeMenu);

// Selecione o primeiro DT da dl de Faq
const faqLista = document.querySelector('.faq-lista');

const forma1 = faqLista.querySelector('dt');
const forma2 = faqLista.children[0];
console.log(forma1);
console.log(forma2);

// Selecione o DD referente ao primeiro DT

const dd1 = forma2.nextElementSibling;
const dd2 = forma1.nextElementSibling;
console.log(dd1);
console.log(dd2);
